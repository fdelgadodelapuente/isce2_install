...
- [we need to copy them to ISCEHOME](#we-need-to-copy-them-to-iscehome)
  - [Add to your path: STACK PROCESSOR (PICK ONE and add to PATH)](#add-to-your-path-stack-processor-pick-one-and-add-to-path)
